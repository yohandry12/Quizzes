...
//   Play,
//   Pause,
//   Send, // Icône pour la soumission de texte
// } from "lucide-react";
// import {
//   getPublicQuizInfo,
...
//     } catch (err) {
//       console.error(
//         "Erreur lors de la soumission de la réponse textuelle:",
//         err
//       );
//     }
//   };
...
//     if (questionValidated[questionId]) {
//       return true;
//     }
...
//                     className="w-full mt-4 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center gap-2"
//                     whileHover={{ scale: 1.02 }}
//                     whileTap={{ scale: 0.98 }}
//                   >
